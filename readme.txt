...
Extend BuddyPress' private message feature by enabling attachments. This plugin enables users to send attachments in private messages. The type of file types allowed and maximum size of the attachement can be controlled by admin.
...
After activating, make sure you change settings according to your liking/requirement. Settings can be found under **Settings>Message Attachemnt** in wp-admin or, on network admin screen if you've activated it network wide.
...
Please contact me http://webdeveloperswall.com/author/ckchaudhary, i plan on writing a separate importer to import old data into new data structure.